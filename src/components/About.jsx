  ...
  return (
    <section id="about" className="relative bg-[#dfe1da] px-5 py-20 md:px-10 md:py-28">
      <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[.72fr_1.28fr]">
        <div className="relative mx-auto w-full max-w-sm border-2 border-[#202321] bg-[#f7f6f0] p-3 shadow-[5px_5px_0_#202321]">
          <span className="absolute -right-2 -top-2 border-2 border-[#202321] bg-[#68bcb9] px-2 py-1 mono text-[9px] uppercase">bio / 02</span>
          <img src={anharImage} alt="Anhar Khoirun Najib" loading="lazy" className="w-full border border-[#202321] object-cover object-top grayscale contrast-125" />
        ...
        <div>
          ...
          <p className="mt-7 max-w-2xl text-lg leading-8 md:text-xl">I am a dedicated web developer with expertise across frontend and backend development. As a .NET Developer, I contribute to SHIELD for Pertamina International Shipping and S&amp;D One for Pertamina Patra Niaga.</p>
          <p className="mt-5 max-w-2xl leading-7">Skilled in ASP.NET, Django, and Laravel, I continually explore IoT, Augmented Reality, Cloud Computing, and Machine Learning—bringing curiosity and a practical mindset to every build.</p>
